...
const ProjectItem: React.FC<{ id: string; name: string; color: string }> = ({ id, name, color }) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-xs text-gray-500 mt-1">Drag to allocate</p>
      </Card>
    </div>
  );
};
...
const ProjectsSidebar: React.FC = () => {
  ...
  return (
    <div className="w-64 border-r bg-white p-4 flex flex-col h-full">
      ...
      <p className="text-sm text-gray-500 mb-4">Drag projects to allocate resources</p>
